...
import { createKeyBoardEvent } from 'ng-devui/utils/testing/event-helper';
...
class TestTagsInputComponent implements OnInit {
  @ViewChild('comp', { static: true }) comp: TagsInputComponent;
  tagList: any = [];
  taskTagConfig: any;
  suggestionList: any = [];
...
describe('tags input', () => {
  ...
  describe('basic', () => {
    it('should have correct classes', () => {
      ...
      expect(domHelper.judgeClasses(classes)).toBeTruthy();
    });
